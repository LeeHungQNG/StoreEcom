...
const ProductUpdate = () => {
  ...
  console.log('🚀 ~ ProductUpdate ~ params:', params);
            ...
            <div className="p-3">
              <div className="flex flex-wrap">
                <div className="one">
                  ...
                  <input type="text" className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white mr-[5rem]" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              ...
              <textarea type="text" className="p-2 mb-3 bg-[#101011]  border rounded-lg w-[95%] text-white" value={description} onChange={(e) => setDescription(e.target.value)} />
