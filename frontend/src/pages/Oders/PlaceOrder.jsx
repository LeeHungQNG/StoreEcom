    ...
    <>
      ...
      <div className="mx-20 mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-8 bg-[#181818]">
          ...
          <button type="button" className="w-full bg-pink-500 text-white py-2 px-4 rounded-full text-lg mt-4" disabled={cart.cartItems === 0} onClick={placeOrderHandler}>
            Place Order
          </button>
